...
def validate_profile(profile: Dict[str, Any], *, active_required_contexts_fn) -> List[str]:
    ...
    validators = (
        ...
        lambda current: _validate_required_context_sets(current, active_required_contexts_fn=active_required_contexts_fn),
        _validate_secret_contract,
        _validate_issue_policy_contract,
        _validate_deps_contract,
        lambda current: _validate_visual_pair_contract(current, active_required_contexts_fn=active_required_contexts_fn),
