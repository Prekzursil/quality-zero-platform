...
class CodacyZeroRetryTests(unittest.TestCase):
    ...
    def test_retry_builds_default_config(self) -> None:
    ...
    def test_retry_does_not_retry_without_pull_request(self) -> None:
        """Cover retry does not retry without pull request."""
        with patch.object(
            check_codacy_zero,
            "_query_codacy_open_issues",
            return_value=(0, [], None),
    ...
    def test_retry_returns_pr_success(self) -> None:
        """Cover retry returns immediately for pull request success."""
        with (
            patch.object(
                check_codacy_zero,
                "_query_codacy_open_issues",
    ...
    def test_commit_scope_fallback_uses_commit_query(self) -> None:
    ...
    def test_commit_scope_fallback_ignores_unresolved(self) -> None:
    ...
    def test_resolve_status_prefers_commit_scope_when_stale(self) -> None:
