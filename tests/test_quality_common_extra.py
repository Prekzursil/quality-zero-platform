"""Additional quality-common normalization tests."""
...
from tests.test_quality_common import QualityCommonTests
...
class QualityCommonExtraTests(unittest.TestCase):
    ...
    def test_normalize_coverage_helper_covers_explicit_inputs(self) -> None:
        """Cover normalize_coverage with explicit inputs."""
        self.assertEqual(
            QualityCommonTests._normalized_explicit_coverage(),
            {
    ...
    def test_normalize_coverage_helper_infers_required_sources_from_command(
        ...
        """Cover inferred required-source extraction."""
        inferred = QualityCommonTests._inferred_coverage()
        self.assertEqual(
    ...
    def test_profile_coverage_normalization_helpers_cover_empty_and_multi_filter_paths(
        ...
        """Cover profile normalization helper edge cases."""
        with patch.object(
    ...
    def test_normalize_codex_environment_helper_covers_string_inputs(self) -> None:
        """Cover codex-environment normalization."""
        self.assertEqual(
    ...
    def test_normalize_issue_policy_supports_defaults_and_shortcuts(self) -> None:
        """Cover issue-policy normalization defaults and shortcuts."""
        self.assertEqual(
    ...
    def test_normalize_deps_supports_defaults_and_shortcuts(self) -> None:
        """Cover dependency-policy normalization and codex-environment cleanup."""
        self.assertEqual(
            normalize_deps(None),
            {
                "enabled": False,
    ...
    def test_finalize_vendors_and_deep_merge_cover_string_inputs(self) -> None:
        """Cover vendor finalization and deep-merge behavior."""
        self.assertEqual(
            finalize_vendors(
                {
